...
const ShowResult = () => {
  const resultList = [
    ...
    },
    {
      ...
      title: "Hillside Escape Condo",
      slug: "hillside-escape-condo",
      state: true,
      description:
        "Escape to the hills with this private and tranquil condo retreat.",
      price: 1700,
      listedDate: "2024-11-09",
      unitId: "TT789012",
      bathroom: 2,
      bedRoom: 2,
      sqft: 70,
