...
const ContactUsAddressBox = ({ icon, header, text }) => {
  return (
    <div className=" gap-6 flex justify-center items-center flex-col w-[411px] border rounded-[19.47px] p-[51.92px] bg-neutral-50 border-neutral-300 h-[288px]">
      <div>{icon}</div>
