  ...
  return (
    <section className="flex flex-col items-start gap-10 mb-10">
      <div className="text-start">
        <h4 className=" text-2xl font-semibold text-neutral-700 font-heading mb-3">
          1. Information We Collect
        </h4>
        <p className="text-[22px] font-normal text-neutral-700">
      ...
      <h4 className=" font-heading text-2xl font-semibold text-neutral-700">
